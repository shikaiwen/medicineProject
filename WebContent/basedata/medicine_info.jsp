...
function addToOrder(){
	var w = window.opener;
	var data = dd.datagrid("getSelections");
	w.appendRow(data);
}
	...
	<div id="addDlg" class="easyui-dialog" style="margin-right:auto;margin-left:auto;width:300px" closed="true" buttons="#dlg-buttons">
		<table id="addMedicineTable">
			<tr><td>药品编号:</td><td><input type="text" size="22" name="medicineNo" id="medicineNo" disabled="disabled"/></td>
				<td>药品名称:</td><td><input type="text" size="22" name="medicineName" id="medicineName"/></td>
			</tr>
			<tr>
				<td>通用名称:</td><td><input type="text" size="22" name="normalName" id="normalName"/></td>
				<td>批准文号:</td><td><input type="text" size="22" name="approvalNumber" id="approvalNumber"/></td>
			</tr>
			<tr>
				<td>产品标签:</td><td><input type="text" size="22" name="productLabel" id="productLabel"/></td>
				<td>规格:</td><td><input type="text" size="22" name="specification" id="specification"/></td>
			</tr>
			<tr>
