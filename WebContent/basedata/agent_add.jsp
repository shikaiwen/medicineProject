...
<form action="<%=base%>basedata/AgentAction!addAgent.action" id="agentForm" method="post">
	...
	<div style="margin-right:auto;margin-left:auto;width:650px">
		<table id="contentTable">
			<tr><td>名称:</td><td><input type="text" name="agent.agentName" class="easyui-validatebox" data-options="required:true" missingMessage="分销商名称不能为空" id="agentName"></td></tr>
			<tr><td>联系人:</td><td><input type="text" name="agent.contactMan"  class="easyui-validatebox" data-options="required:true" missingMessage="联系人不能为空" id="contactMan"></td></tr>
			<tr><td>联系电话:</td><td><input type="text" name="agent.telephone" class="easyui-validatebox" data-options="required:true,validType:'length[6,10]'" missingMessage="请输入6-11数字" invalidMessage="请输入6-11数字" id="telephone"></td></tr>
			...
			<tr><td>详细地址：</td><td><input type="text" name="agent.detailedAddress" id="detailedAddress"></td></tr>
        ...
        <a href="javascript:void(0)" class="easyui-linkbutton" iconCls="icon-ok" onclick="addAgent()">保存</a>&nbsp;&nbsp;&nbsp;
