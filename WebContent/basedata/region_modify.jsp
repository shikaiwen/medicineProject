...
<script type="text/javascript">
	...
	function modifyAgent(){
		...
		//为隐藏的名字赋值
		try{
			var selectedProvinceOption = $("#provinceSelect").get(0).options[$("#provinceSelect").get(0).selectedIndex];
			$("#hiddenProvinceName").val(selectedProvinceOption.innerHTML);
			var selectedCityOption = $("#citySelect").get(0).options[$("#citySelect").get(0).selectedIndex];
			$("#hiddenCityName").val(selectedCityOption.innerHTML);
			var selectedAreaOption = $("#areaSelect").get(0).options[$("#areaSelect").get(0).selectedIndex];
			$("#hiddenAreaName").val(selectedAreaOption.innerHTML);
		}catch(e){
		}
...
<body>
<form action="<%=base%>basedata/AgentAction!modifyRegion.action" id="agentForm" method="post">
	<div>
				<table width="95%" border="0" cellspacing="0" cellpadding="0"
					...
					<tr>
						<td width="522" class="p1" height="17" nowrap>
							...
							&nbsp;
							<b>基础数据管理&gt;&gt;<span id="operate_module">区域修改</span></b>
						</td>
					</tr>
				</table>
	...
	<div style="margin-right:auto;margin-left:auto;width:650px">
		<table id="contentTable">
			...
			<tr><td>名称:</td><td><input type="text" name="agent.agentName" id="agentName" value='<s:property value="agent.agentName"/>'> </td></tr>
			<tr><td>负责人:</td><td><input type="text" name="agent.contactMan" id="contactMan" value='<s:property value="agent.contactMan"/>'></td></tr>
			...
			<tr><td>电子邮件:</td><td><input type="text" name="agent.email" id="email" value='<s:property value="agent.email"/>'></td></tr>
