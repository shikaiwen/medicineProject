...
<body>
<form action="<%=base%>basedata/AgentAction!addRegion.action" id="regionForm" method="post">
	<div>
				<table width="95%" border="0" cellspacing="0" cellpadding="0"
					...
					<tr>
						<td width="522" class="p1" height="17" nowrap>
							...
							&nbsp;
							<b>基础数据管理&gt;&gt;<span id="operate_module">添加区域</span></b>
						</td>
					</tr>
				</table>
	...
	<div style="margin-right:auto;margin-left:auto;width:650px">
		<table id="contentTable">
			<tr><td>名称:</td><td><input type="text" name="agent.agentName" class="easyui-validatebox" data-options="required:true" missingMessage="区域不能为空" id="agentName"></td></tr>
			<tr><td>负责人:</td><td><input type="text" name="agent.contactMan" class="easyui-validatebox" data-options="required:true" missingMessage="负责人不能为空"  id="contactMan"></td></tr>
			<tr><td>联系电话:</td><td><input type="text" name="agent.telephone" class="easyui-validatebox" data-options="required:true,validType:'length[6,11] '"  missingMessage="请输入6-10数字" invalidMessage="请输入6-11数字" id="telephone"></td></tr>
			<tr><td>固定电话:</td><td><input type="text" name="agent.fixedPhone" class="easyui-validatebox" data-options="required:true,validType:'length[6,15]'" missingMessage="请输入6-15数字" invalidMessage="请输入6-15数字"  id="fixedPhone"></td></tr>
			<tr><td>电子邮件:</td><td><input type="text" name="agent.email" class="easyui-validatebox" data-options="required:true,validType:'email'" missingMessage="该项不能为空！" invalidMessage="请输入合法的邮件地址！" id="email"></td></tr>
			<tr><td>地址:</td>
			...
			<input type="hidden" name="agent.isAgent" value="N"/>
			<input type="hidden" name="agent.pid" id="pid"/>
		</table>
		
	<div id="oper_button" style="margin-left:20px;margin-top:20px">  
        <a href="javascript:void(0)" class="easyui-linkbutton" iconCls="icon-ok" onclick="addRegion()">保存</a>&nbsp;&nbsp;&nbsp;
        <a href="javascript:void(0)" class="easyui-linkbutton" iconCls="icon-cancel" onclick="javascript:$('#dlg').dialog('close')">重置</a>  
    </div> 
	</div>
	</div>
</form>
