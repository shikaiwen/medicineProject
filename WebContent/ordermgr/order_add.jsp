...
<body>
			...
			<table width="95%" border="0" cellspacing="0" cellpadding="0"
					...
					<tr>
						<td width="522" class="p1" height="17" nowrap>
							...
							&nbsp;
							<b>订单管理&gt;&gt;<span id="operate_module">添加订单</span></b>
						</td>
					</tr>
				</table>
	...
	<div style="margin-right:auto;margin-left:auto;width:700px">
        ...
        <span id="saveSpan"><a href="javascript:void(0)" class="easyui-linkbutton" iconCls="icon-ok" onclick="saveOrder()">保存</a>&nbsp;&nbsp;&nbsp;</span>
...
<!-- style="display:none;" -->
<form id="modifyFileForm"  action="<%=base%>order/OrderAction!importOrder.action" target="hidden_frame" encType="multipart/form-data" method="post">
